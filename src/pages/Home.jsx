...
function ScrollSection({ children, className = "", bgClass, id }) {
  ...
  return (
    ...
    >
      <motion.div style={{ scale, y }} className={`${SECTION_INNER} py-12 relative`}>
        {children}
      </motion.div>
    </motion.section>
  );
...
function Orb({ className = "" }) {
  return (
    <div
      ...
      style={{ width: 400, height: 400, background: "radial-gradient(circle, rgba(34,211,238,0.4) 0%, transparent 70%" }}
      aria-hidden
    />
  );
}
...
const digitalTwinIcons = [AlertTriangle, Shield, AlertTriangle, Flame, Scale, Users, FileStack, FileStack];
...
export default function Home() {
  ...
  useEffect(() => {
    const t = setInterval(() => setDigitalTwinIndex((i) => (i + 1) % digitalTwinItems.length), 3200);
  ...
  return (
    <div className="relative text-white overflow-x-hidden flex flex-col items-center">
      ...
      <section ref={heroRef} className="relative w-full min-h-screen flex flex-col items-center justify-start overflow-hidden bg-black pt-[20vh] sm:pt-[24vh]">
        <video
          ref={videoRef}
          src={heroVideo}
          muted
      ...
      <div ref={nextSectionRef} className="w-full flex flex-col">
        ...
        <ScrollSection bgClass={getSectionBg(0)}>
          <div className="relative text-center">
            ...
            <GridOverlay />
            <FadeUp>
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-cyan-400 via-cyan-300 to-cyan-400 text-transparent bg-clip-text">
                Why MiHub
              </h2>
            </FadeUp>
            <FadeUp>
              <p className="mt-8 text-2xl md:text-3xl lg:text-4xl text-white/90 max-w-4xl mx-auto leading-relaxed">
                MiHub lets you see all you need to know about your building, yesterday, today and for tomorrow.
              </p>
            </FadeUp>
            <FadeUp>
              <p className="mt-6 text-xl md:text-2xl lg:text-3xl text-white/80 max-w-3xl mx-auto">
                It doesn't just help you see what's happening now, it helps you understand what's about to happen next.
              </p>
            </FadeUp>
          </div>
        </ScrollSection>
          ...
          <div className="relative text-center">
            ...
            <FadeUp>
              <p className="mt-8 text-xl md:text-2xl lg:text-3xl text-white/85 max-w-4xl mx-auto leading-relaxed">
                Buildings are complex. They produce a lot of data. All too often that data is inaccessible, or there is simply so much information that it becomes overwhelming. MiHub lets you cut through the noise to see and understand the data that you need to know.
              </p>
            </FadeUp>
          </div>
        </ScrollSection>
        ...
        <ScrollSection bgClass={getSectionBg(2)}>
          <div className="relative">
            <GridOverlay />
            <FadeUp>
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-center text-white mb-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-12">
                {apiFeatures.map(({ label, icon: Icon }, i) => (
                  ...
                  >
                    ...
                    <span className="text-base md:text-lg font-medium text-white/90 text-center">{label}</span>
                  </div>
                ))}
              </div>
            </FadeUp>
            <FadeUp>
              <p className="mt-12 text-center text-xl md:text-2xl text-white/80 max-w-3xl mx-auto">
                No more jumping between tools or systems. Just one source, always up to date and always learning.
              </p>
            </FadeUp>
          </div>
        </ScrollSection>
        ...
        <ScrollSection bgClass={getSectionBg(3)}>
          <div className="relative text-center">
            <Orb className="top-0 right-0" />
            <Orb className="bottom-0 -left-20" />
            <FadeUp>
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 text-transparent bg-clip-text">
                Every feature, powered by our own AI
              </h2>
            </FadeUp>
            <FadeUp>
              <p className="mt-8 text-xl md:text-2xl lg:text-3xl text-white/85 max-w-4xl mx-auto leading-relaxed">
                MiHub is fully AI-enabled. Every insight, automation, and prediction comes from our own AI engine, trained specifically on your data. MiHub knows your building better than ever before, it's learning every day, processing millions of points of data making sure you get the very best advice and support.
              </p>
            </FadeUp>
            <FadeUp>
              <div className="mt-10 inline-flex items-center gap-2 text-cyan-400">
                <Sparkles size={28} />
                <span className="font-semibold text-xl md:text-2xl">AI-powered insights</span>
              </div>
            </FadeUp>
          </div>
        </ScrollSection>
          ...
          <div className="relative flex flex-col lg:flex-row items-center gap-12 lg:gap-16 w-full">
            <FadeUp className="flex-1 min-w-0 lg:max-w-md">
              ...
              <p className="mt-8 text-xl md:text-2xl lg:text-3xl text-white/85 leading-relaxed">
                MiHub gives you more than just day-to-day management. MiHub is your starting point for creating your building's digital twin.
              </p>
            </FadeUp>
          ...
          <div className="relative text-center">
            ...
            <FadeUp>
              <p className="text-xl md:text-2xl lg:text-3xl text-white/85 max-w-4xl mx-auto mb-12">
                It's important because in the future, your building's digital twin will help you and the building's owners understand:
              </p>
            </FadeUp>
            <FadeUp>
              <div className="inline-flex flex-col items-center justify-center gap-4 p-10 rounded-2xl border border-cyan-400/20 bg-white/[0.03] w-full max-w-2xl h-[200px]">
                <div className="flex items-center justify-center gap-4 text-cyan-400 text-center">
                  {React.createElement(digitalTwinIcons[digitalTwinIndex], { size: 36 })}
        ...
        <ScrollSection bgClass={getSectionBg(6)}>
          <div className="relative text-center">
            ...
            <FadeUp>
              <p className="mt-8 text-xl md:text-2xl lg:text-3xl text-white/85 max-w-4xl mx-auto leading-relaxed">
                Whether you're managing a single building or an entire portfolio, MiHub's powerful dashboards and predictive analytics changes how you see, manage, and understand your buildings. Even simple things like security reports, maintenance reports can all be collated and added into the knowledge base.
              </p>
            </FadeUp>
          </div>
        </ScrollSection>
        ...
        <ScrollSection bgClass={getSectionBg(7)}>
          <div className="relative text-center">
            ...
            <GridOverlay />
            <FadeUp>
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-cyan-400 to-cyan-300 text-transparent bg-clip-text">
                The Data Room — Live. Intelligent. Always current.
              </h2>
            </FadeUp>
            <FadeUp>
              <p className="mt-8 text-xl md:text-2xl lg:text-3xl text-white/85 max-w-4xl mx-auto leading-relaxed">
                A constantly updating data room for your building. Every document, drawing, log, sensor reading, and report, automatically organised, securely stored, and continuously refreshed. MiHub's AI-powered data room becomes your single destination for everything your building knows, learns, and generates. No manual updates. No version confusion.
              </p>
            </FadeUp>
          </div>
        </ScrollSection>
        ...
        <ScrollSection bgClass={getSectionBg(9)}>
          <div className="relative text-center">
            ...
            <FadeUp>
              <span className="text-xl md:text-2xl lg:text-3xl text-white/80">With projects starting from </span>
              ...
              <span className="text-xl md:text-2xl lg:text-3xl text-white/80">, cost is no longer a barrier.</span>
            </FadeUp>
            <FadeUp>
              <p className="mt-8 text-xl md:text-2xl text-white/80 max-w-3xl mx-auto">
                How do we do this? That's a closely guarded secret, the fruits of years of hard-work, blood, sweat and tears and £millions in R&D.
              </p>
            </FadeUp>
          </div>
        </ScrollSection>
          ...
          <div className="relative text-center">
            ...
            <FadeUp>
              <p className="text-2xl md:text-3xl lg:text-4xl text-white/90">
                But we can say: <strong className="text-cyan-400">"We are unique."</strong>
              </p>
            </FadeUp>
            <FadeUp>
              <p className="mt-8 text-xl md:text-2xl lg:text-3xl text-white/85 max-w-4xl mx-auto leading-relaxed">
                We are the only platform that addresses the whole as a series of individual challenges, adding value at each and every step making sure that in the end{" "}
                <span className="inline-block font-bold text-4xl md:text-6xl lg:text-7xl bg-gradient-to-r from-cyan-400 to-cyan-300 text-transparent bg-clip-text">
                  1+1 = 3
                </span>
        ...
        <ScrollSection bgClass={getSectionBg(11)}>
          <div className="relative text-center">
            ...
            <FadeUp>
              <p className="text-xl md:text-2xl lg:text-3xl text-white/85 max-w-3xl mx-auto mb-10">
                It's a genius solution and hence why we say:
              </p>
            </FadeUp>
            <FadeUp>
              <h2 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold bg-gradient-to-r from-cyan-400 via-white to-cyan-400 text-transparent bg-clip-text">
                MiHub – the world's most advanced real estate AI platform.
              </h2>
            </FadeUp>
          </div>
          ...
          <div className="relative text-center">
            ...
            <FadeUp>
              <p className="mt-8 text-xl md:text-2xl lg:text-3xl text-white/85 max-w-3xl mx-auto">
                Every organisation's needs are unique. That's why MiHub is designed to adapt. But we won't list every feature here. Get in touch to find out what MiHub can do for you.
              </p>
            </FadeUp>
            <FadeUp>
              <div className="mt-12">
